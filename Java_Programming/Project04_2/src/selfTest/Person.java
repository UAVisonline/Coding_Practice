...
public class Person {
	...
	{
		if(person == null) //if Data is NULL
		{
			System.out.println("The person data is NULL");
			System.exit(1);
		}
		name = person.name;
		born = new Date(person.born);
		if(person.died != null) died = new Date(person.died); //if died data is not null
		else died = null;
	}
	...
	public Date getBirthDate() { 
		Date retborn = new Date(this.born); //generate return Date object
		return retborn;
	}
